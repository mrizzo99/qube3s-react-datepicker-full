...
export default function App() {
  ...
  const [rangeInputMobileSheet, setRangeInputMobileSheet] = useState<DemoRange>({ start: null, end: null })
  ...
  const [rangeInputDateTime12h, setRangeInputDateTime12h] = useState<DemoRange>({ start: null, end: null })
  const [rangeInputDateTime24h, setRangeInputDateTime24h] = useState<DemoRange>({ start: null, end: null })
  ...
  const activeSummary =
    activeTab === 'core'
      ...
      : {
          ...
          description:
            'Plus adds opinionated product features: constraints, async validation, range selection, time selection, mobile sheet behavior, and adapter surfaces.'
        }
            ...
            <div className="relative">
              ...
              <div className="mt-6 grid gap-4 xl:grid-cols-2">
                ...
                <SummaryCard
                  title="Plus"
                  badge="Advanced"
                  description="Product-ready workflows for constrained booking, multi-month range selection, time-aware ranges, mobile sheet mode, and design-system adapters."
                  highlights={['Constraints', 'Range + time', 'Adapters']}
                  tone="plus"
                />
              </div>
            </div>
