...
const shadcnRangeCalendarTheme: RangeCalendarTheme = {
  ...
  monthPanelClassName: 'w-[320px] rounded-md border border-border bg-muted/30 p-2',
  monthPanelTitleClassName: 'mb-1 text-center text-sm font-medium text-foreground',
  weekdayRowClassName: 'mb-2 grid grid-cols-7 gap-1 text-xs text-muted-foreground',
  ...
  dayButtonClassName: ({ rangeEdge, inRange, faded, focused }) =>
    [
      'justify-self-center inline-flex h-9 w-9 items-center justify-center rounded-md text-sm font-normal transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring',
